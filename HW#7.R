...
Group: Nehsma and Fareha 


getwd()
setwd("C:/Users/hcass/OneDrive/Documents/R/R Work - Econometrics/ecob2000_lecture1")
...
# Here we find a prediction with a summary to analyze the effect of different variables. It seemingly states that certain demographics such as females, African-Americans and others are less likely to have health coverage.
...
I would assume that the Elastic net is the the more accuate model of the models weve analyzed with. It's 'guessing' abulity just seems to perform better than the others.'